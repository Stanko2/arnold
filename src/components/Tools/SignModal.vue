<template>
    <div class="d-flex flex-row flex-wrap justify-content-around" @mousedown="deselectAll">
        <div v-for="signature in signatures" :key="signature.id">
            <div class="card" style="width: 300px; height: 150px;" @mouseover="signature.hover = true" @mouseleave="signature.hover = false">
                <canvas ref="signCanvas" class="w-100 h-100"></canvas>
                <div v-if="signature.hover && !signature.canvas.isDrawingMode" class="d-flex justify-content-center align-items-center">
                    <div class="d-flex">
                        <button class="btn btn-primary" @click="edit(signature.id)">edit</button>
                        <button class="btn btn-danger" @click="remove(signature.id)">remove</button>
                    </div>
        ...
        <div class="card d-flex justify-content-center align-items-center btn" style="width: 300px; height: 150px;" @click="addSignature">
